        ...
        <>
            ...
            <section id="inicio">
                ...
                <div className="fisio-pelvica">
                    ...
                    <p>É uma área da fisioterapia voltada para a prevenção e o tratamento de disfunções no assoalho pélvico, que afetam diretamente a qualidade 
                        de vida da mulher — como incontinência urinária, dores íntimas, e questões no pré e pós-parto.
                        <br /><br />O tratamento é realizado por meio de exercícios específicos, orientações e técnicas manuais, visando fortalecer e reabilitar a musculatura pélvica.
                        <br /><br />Além disso, a fisioterapia pélvica pode ajudar na recuperação pós-cirúrgica e na melhoria da função sexual.
                    </p>
                </div>

                <div className="publico-alvo">
                    <h2>Pra quem é indicado?</h2>
                    <p>A fisioterapia pélvica é indicada para mulheres que apresentam sintomas como:</p>
                    ...
                    <p>Se você se identifica com algum desses sintomas, agende uma consulta e venha conhecer o meu trabalho!</p>
